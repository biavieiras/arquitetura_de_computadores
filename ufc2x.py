...
firmware[49] = 0b00010010100000110101001000001001
## MAR <- MBR; read_word; GOTO 51
firmware[50] = 0b00010011000000010100100000010010
## H <- MDR; GOTO 52
firmware[51] = 0b00010011100000010100000001000000
## X <- X - H; if X - H < 0 GOTO 52 + 256; else 52
firmware[52] = 0b00010011101000111111000100000011
### [295] X é menor que 0
## X <- X + H; GOTO 0
firmware[308] = 0b00000000000000111100000100000011

# X <- memory[address](Pull)
## PC <- PC + 1; MBR <- read_byte(PC); GOTO 54
firmware[53] = 0b000110110_00000110101001000001001
## MAR <- MBR; read_word; GOTO 55
firmware[54] = 0b000110111_00000010100100000010010
## X <- MDR; GOTO 0
firmware[55] = 0b000000000_00000010100000100000000

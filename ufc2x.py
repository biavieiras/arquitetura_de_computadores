...
firmware[71] = 0b001001000_00000110101001000001001
## MAR <- MBR; read_word; GOTO 73
firmware[72] = 0b001001001_00000010100100000010010
## H <- MDR; GOTO 74
firmware[73] = 0b001001010_00000010100000001000000
...
## MAR <- MBR; read_word; GOTO 55
firmware[76] = 0b001001101_00000010100100000010010
## Y <- MDR; GOTO 0
firmware[77] = 0b000000000_000_00010100_000010_000_000

# if Y == 0 goto address(if==0)
## 15: Y <- Y; if alu = 0 goto 335 else goto 79
firmware[78] = 0b001001111_001_00010100_000100_000_011
## 16: PC <- PC + 1; goto 0
firmware[79] = 0b00000000_000_00110101_001000_000_001
## 272: goto 13
firmware[335]= 0b00001101_000_00000000_000000_000_000
...
# Y <- Y - 1; GOTO 0(dec)
firmware[81] = 0b000000000_0000_0110110_000010_000_100

'''
# Y <- Y * memory[adress](add)
## 17: PC <- PC + 1; fetch; goto 18
firmware[69] = 0b00010010_000_00110101_001000_001_001
## 18: MAR <- MBR; read; goto 19
firmware[70] = 0b000010011_000_00010100_100000_010_010
## 19: H <- MDR; GOTO 20
firmware[71] = 0b000010100_000_00010100_000001_000_000
## 20: if X - H < 0; GOTO 72 + 256; else GOTO 72
firmware[72] = 0b000010101_01000111111000000000011
### [21] H é menor ou igual
## Y <- H; GOTO 22
firmware[73] = 0b000010110_00000011000000010000000
### [277] H é maior
## Y <- X; GOTO 23
firmware[328] = 0b000010111_00000010100000010000011
## H <- X; GOTO 23
firmware[74] = 0b000010111_00000010100000001000011
'''
